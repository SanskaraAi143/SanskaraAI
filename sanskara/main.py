...
import os
# from arize.otel import register # Commented out for now
...
# tracer_provider = None # Commented out for now
...
# from openinference.instrumentation.google_adk import GoogleADKInstrumentor # Commented out for now

# Finish automatic instrumentation
# GoogleADKInstrumentor().instrument(tracer_provider=tracer_provider) # Commented out for now
import nest_asyncio
nest_asyncio.apply()
